...
fp32_attention = True
load_from = "/data3/zyx/pixart/PixArt-Sigma/PixArt-Sigma-XL-2-512-MS.pth"  # https://huggingface.co/PixArt-alpha/PixArt-Sigma
resume_from = None
vae_pretrained = "/data3/zyx/pixart/pixart_sigma_sdxlvae_T5_diffusers/vae"  # sdxl vae
...
gradient_clip = 0.01
optimizer = dict(type='CAMEWrapper', lr=2e-4, weight_decay=0.0, betas=(0.9, 0.999, 0.9999), eps=(1e-30, 1e-16))
...
work_dir = '/data3/zyx/pixart/output/debug'
