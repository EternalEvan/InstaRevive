...
fp32_attention = True
load_from = "/data3/zyx/pixart/output/bfr-2-visual/checkpoints/epoch_10_step_6950.pth"  # https://huggingface.co/PixArt-alpha/PixArt-Sigma
resume_from = None
...
work_dir = '/data3/zyx/pixart/output/bfr-more'
