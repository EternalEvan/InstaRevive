...
def get_args():
    ...
    parser.add_argument('--txt_file', default='/home/zyx/PixArt-sigma/asset/samples.txt', type=str)
    parser.add_argument('--model_path', default='/data3/zyx/pixart/PixArt-Sigma/PixArt-Sigma-XL-2-512-MS.pth', type=str)
